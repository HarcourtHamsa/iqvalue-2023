...
function Privacy() {
  return (
    <Box>
      <Head>
        <title>Privacy Policy - IQ Value Investments</title>
        ...
        <Box>
          <Stack as={Container} maxW={"6xl"} mt={10}>
            <Heading
              ...
              mb={3}
            >
              <Text>Privacy Policy for IQ Value Investments</Text>
            </Heading>
            <Text mt={10}>
              At IQ Value Investments, accessible from https://IQ Value Investments.network, one of our
              ...
              and recorded by IQ Value Investments and how we use it. If you have additional
              questions or require more information about our Privacy Policy, do
              not hesitate to contact us through email at
              support@IQ Value Investments.network
            </Text>
          </Stack>
          ...
          <Text p={4}>
            IQ Value Investments follows a standard procedure of using log files. These
          ...
          <Text p={4}>
            Like any other website, IQ Value Investments uses &apos; cookies&apos; . These
