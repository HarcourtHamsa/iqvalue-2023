...
function Affilate() {
  return (
    <Box>
      <Head>
        <title>Affilates - IQ Value Investments</title>
        ...
        <Box p={4}>
          ...
          >
            <Heading
              ...
              mb={3}
            >
              <Text>IQ Value Investments Affiliate Network</Text>
            </Heading>
            <Text mt={10}>
              The IQ Value Investments platform welcomes you to become our partner and
          ...
          <Container maxW={"6xl"} mt={0}>
            <SimpleGrid columns={{ base: 1, md: 2, lg: 2 }}>
              <Box p={{ base: 2, md: 12 }} borderRadius={"10px"}>
                ...
                <Text mt={2}>
                  IQ Value Investments Affiliate Program offers you lifetime commission
                ...
                <List spacing={3} textAlign="start" mt={10}>
                  ...
                  <ListItem>
                    <ListIcon as={FaCheckCircle} color="orange.500" />
                    Make a YouTube video and review IQ Value Investments and its benefits
                  </ListItem>
                </List>
              </Box>
